                ...
                <section class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 my-1">
                        ...
                        <input type="email" name="email" value="{{ @$edit->email }}" class="form-control" required
                            placeholder="devid@gamil.com" id="">
                    </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 my-1">
                        ...
                        <input type="date" name="join_date" value="{{ @$edit->join_date }}" class="form-control"
                            placeholder="" id="">
                    </div>

                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 my-1">
                        <label for="" class="text-muted">Employee Date of Birth </label>
                        <input type="date" name="date_of_birth" value="{{ @$edit->date_of_birth }}" class="form-control"
                            placeholder="" id="">
                    </div>
