    ...
    <section class="">
        <div class="shadow px-4 py-4 bg-white">
            <form action="@route('admin.billing.store')" method="POST">
                    ...
                    <div class="col-12 col-sm-12 col-md-7 col-lg-7 ">
                        <div class="float-end">
                            ...
                            <div class="d-flex mt-1">
                                ...
                                <input required type="date" value="{{date('Y-m-d') }}" class="form-control ml-3" name="date" id="">
                            </div>
                            ...
                            <div class="d-flex mt-1">
                                ...
                                <input type="email" required class="form-control ml-3" name="email" id="">
                            </div>
                ...
                <input type="text" class="form-control mb-1" placeholder="type here" name="note" id="">
                <div id="dynamic_form">
                    <span id="result"></span>
    ...
    <script>
        $(document).ready(function() {
            ...
            function dynamic_field(number) {
                ...
                html += '<td><input required type="number" value="0" name="govt_fees[]" class="form-control" /></td>';
                html += '<td><input required type="number" value="0" name="others_expenses[]" class="form-control" /></td>';
                html += '<td><input required type="number" value="0" name="professional_fees[]" class="form-control" /></td>';
                html += '<td><input required type="number" value="0" name="vat[]" class="form-control" /></td>';
                html += '<td><input required type="number" value="0" name="tax[]" class="form-control" /></td>';
                if (number > 1) {
                    html +=
